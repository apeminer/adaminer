...
// var minersAddr = '0x87D1DCb01F14394952FBB65Bd800170dc3149f88';
// var tokenAddr = '0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47';
...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		...
		alert("Approve spending " + trx + " ADA first");
	} else {
...
function tokenPrice(callback) {	
	const query = "https://api.coingecko.com/api/v3/simple/price?ids=cardano&vs_currencies=usd";	
